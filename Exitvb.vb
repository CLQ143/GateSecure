...
Public Class Exitvb
    Dim SSC As ServerStringConnection = New ServerStringConnection
    Public Serverstring As New MySqlConnection(SSC.s)

    Dim COMMAND As MySqlCommand
    Dim error1 As Boolean


    Public Sub Exitvb_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
